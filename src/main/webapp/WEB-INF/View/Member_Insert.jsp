...
<main id="Member_Insert_Main">
	...
	<!-- 아이디 -->
		...
		<div class="box id_box">
			...
			<div id="input_id_box" class="input_wrapper">
	...
	<!-- 비밀번호 -->
		...
		<div class="box pw_box">
			...
			<div id="input_pw_box" class="input_wrapper">
				<input class="input" type="password" id="pw" name="pw" required>
			</div> 
		</div>
	...
	<!-- 생년월일 -->
		...
		<div class="box birth_box">
			...
			<div id="input_birth_box" class="input_wrapper select">
				<select class="select birth_box birth_box_year" id="birth_year" name="birth-year">
					<option disabled selected>출생 연도</option>
				</select>
				<select class="select birth_box birth_box_month" id="birth_month" name="birth-month" >
					<option disabled selected>월</option>
				</select>
				<select class="select birth_box birth_box_day" id="birth_day" name="birth-day">
	...
	<!-- 닉네임 -->
		<div class="box nickname_box">
			...
			<div id="input_nickname_box" class="input_wrapper">
